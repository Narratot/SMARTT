...
typedef struct {
  ...
  __DECLARE_VAR(REAL,SG1_PRESS)
  __DECLARE_VAR(REAL,SG2_PRESS)
  __DECLARE_VAR(REAL,SD_VALVE)
  __DECLARE_VAR(REAL,SD_ONOFF)
  ...
  __DECLARE_VAR(REAL,ADD34_OUT)
  __DECLARE_VAR(REAL,DIV33_OUT)
  __DECLARE_VAR(REAL,LIMIT36_OUT)
