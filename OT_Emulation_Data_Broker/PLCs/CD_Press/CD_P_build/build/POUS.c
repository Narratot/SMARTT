...
void SD_P_init__(SD_P *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->CD_PRESS,0,retain)
  __INIT_VAR(data__->CC_PUMP_SPEED,0,retain)
  __INIT_VAR(data__->CC_ONOFF,1.0,retain)
  __INIT_VAR(data__->MANIPIO_CONTROL,0.0,retain)
  __INIT_VAR(data__->KPI,0.01,retain)
  __INIT_VAR(data__->TI,10.0,retain)
  __INIT_VAR(data__->SET_POINT,5199.6,retain)
  __INIT_VAR(data__->INIT,95.0,retain)
...
void SD_P_body__(SD_P *data__) {
  ...
  __SET_VAR(data__->,SUB27_OUT,,SUB__REAL__REAL__REAL(
    ...
    (REAL)__GET_VAR(data__->CD_PRESS,)));
  ...
  __SET_VAR(data__->,SEL23_OUT,,SEL__REAL__BOOL__REAL__REAL(
    ...
    (REAL)__GET_VAR(data__->LIMIT18_OUT,),
    (REAL)__GET_VAR(data__->CC_PUMP_SPEED,)));
  __SET_VAR(data__->,CC_PUMP_SPEED,,__GET_VAR(data__->SEL23_OUT,));
