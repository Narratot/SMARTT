...
typedef struct {
  ...
  __DECLARE_VAR(REAL,SG1_LEVEL)
  __DECLARE_VAR(REAL,SG2_LEVEL)
  __DECLARE_VAR(REAL,RX_POWER)
  __DECLARE_VAR(REAL,FW_PUMPSPEED_1)
  __DECLARE_VAR(REAL,FW_PUMPSPEED_2)
  __DECLARE_VAR(REAL,FW_PUMPSPEED_3)
  __DECLARE_VAR(REAL,FW_PUMP_ONOFF_1)
  __DECLARE_VAR(REAL,FW_PUMP_ONOFF_2)
  __DECLARE_VAR(REAL,FW_PUMP_ONOFF_3)
