...
void SG_P_PLC_init__(SG_P_PLC *data__, BOOL retain) {
  __INIT_VAR(data__->TIME_IN,0,retain)
  __INIT_VAR(data__->TIME_OUT,0,retain)
  __INIT_VAR(data__->SG1_PRESSURE,0,retain)
  __INIT_VAR(data__->SG2_PRESSURE,0,retain)
  __INIT_VAR(data__->RX_POWER,0,retain)
  __INIT_VAR(data__->TB_VALVE_POS,0,retain)
  __INIT_VAR(data__->MANIPIO_CONTROL,0.0,retain)
  __INIT_VAR(data__->KPI,0.1,retain)
...
// Code part
void SG_P_PLC_body__(SG_P_PLC *data__) {
  // Initialise TEMP variables
  ...
  __SET_VAR(data__->,ADD30_OUT,,ADD__REAL__REAL(
    ...
    NULL,
    (UINT)2,
    (REAL)__GET_VAR(data__->SG1_PRESSURE,),
    (REAL)__GET_VAR(data__->SG2_PRESSURE,)));
  ...
  __SET_VAR(data__->,SEL23_OUT,,SEL__REAL__BOOL__REAL__REAL(
    ...
    (REAL)__GET_VAR(data__->LIMIT18_OUT,),
    (REAL)__GET_VAR(data__->TB_VALVE_POS,)));
  __SET_VAR(data__->,TB_VALVE_POS,,__GET_VAR(data__->SEL23_OUT,));
