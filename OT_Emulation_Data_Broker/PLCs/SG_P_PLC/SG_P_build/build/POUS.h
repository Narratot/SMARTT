...
typedef struct {
  ...
  __DECLARE_VAR(REAL,SG1_PRESSURE)
  __DECLARE_VAR(REAL,SG2_PRESSURE)
  __DECLARE_VAR(REAL,RX_POWER)
  __DECLARE_VAR(REAL,TB_VALVE_POS)
  __DECLARE_VAR(REAL,MANIPIO_CONTROL)
  __DECLARE_VAR(REAL,KPI)
  __DECLARE_VAR(REAL,TI)
  __DECLARE_VAR(REAL,LOOK_UP_TEST)
  INTEGRAL INTEGRAL0;
  __DECLARE_VAR(BOOL,EQ24_OUT)
  __DECLARE_VAR(REAL,ADD30_OUT)
  __DECLARE_VAR(REAL,DIV31_OUT)
  __DECLARE_VAR(REAL,LOOK_UP33_OUT)
