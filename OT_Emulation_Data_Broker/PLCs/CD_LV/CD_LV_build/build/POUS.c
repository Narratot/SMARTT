...
void CD_LV_PLC_init__(CD_LV_PLC *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->CD_LEVEL,0,retain)
  __INIT_VAR(data__->RX_POWER,0,retain)
  __INIT_VAR(data__->CE_PUMP_SPEED_1,0,retain)
  __INIT_VAR(data__->CE_PUMP_SPEED_2,0,retain)
  __INIT_VAR(data__->CE_PUMP_SPEED_3,0,retain)
  __INIT_VAR(data__->CE_PUMP_ONOFF_1,1.0,retain)
  __INIT_VAR(data__->CE_PUMP_ONOFF_2,1.0,retain)
  __INIT_VAR(data__->CE_PUMP_ONOFF_3,0.0,retain)
  __INIT_VAR(data__->MANIPIO_CONTROL,0.0,retain)
  __INIT_VAR(data__->KPI,-100.0,retain)
  __INIT_VAR(data__->TI,60.0,retain)
  __INIT_VAR(data__->SET_POINT,1.0,retain)
...
void CD_LV_PLC_body__(CD_LV_PLC *data__) {
  ...
  __SET_VAR(data__->,SUB27_OUT,,SUB__REAL__REAL__REAL(
    ...
    (REAL)__GET_VAR(data__->CD_LEVEL,)));
  ...
  __SET_VAR(data__->,SEL23_OUT,,SEL__REAL__BOOL__REAL__REAL(
    ...
    (REAL)__GET_VAR(data__->LIMIT18_OUT,),
    (REAL)__GET_VAR(data__->CE_PUMP_SPEED_1,)));
  __SET_VAR(data__->,CE_PUMP_SPEED_1,,__GET_VAR(data__->SEL23_OUT,));
  __SET_VAR(data__->,CE_PUMP_SPEED_2,,__GET_VAR(data__->SEL23_OUT,));
  __SET_VAR(data__->,CE_PUMP_SPEED_3,,__GET_VAR(data__->SEL23_OUT,));
