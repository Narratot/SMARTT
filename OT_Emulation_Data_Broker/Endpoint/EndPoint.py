...
class MB_PLC:
    ...
    def read(self, mem_addr, formating=None):
        ...
        # decoder dictionary
        Decode_dict = {'16_float': float_16, '32_float': float_32, '64_float': float_64, '16_int': int_16,
                       '32_int': int_32, '64_int': int_64, '16_uint': uint_16, '32_uint': uint_32, '64_uint': uint_64}

        try:
            # Set up decoder
            decoder = BinaryPayloadDecoder.fromRegisters(results.registers, byteorder=self.byteOrder,
    ...
    def write(self, mem_addr, value, formating=None):
        ...
        # encoder dictionary
        Encode_dict = {'16_float': float_16, '32_float': float_32, '64_float': float_64, '16_int': int_16,
                       '32_int': int_32, '64_int': int_64, '16_uint': uint_16, '32_uint': uint_32, '64_uint': uint_64}
...
if __name__ == "__main__":
    ...
    for i in range(nPLC):
        ...
        Comms[i].Set(Time_Mem=Time_Mem_I[i], Scan_Time=scanTime_I[i], actuator=Act, sensor=Sen, SensorTags=S_Tags,
                     SensorMem=S_Mem, ActuatorTags=A_Tags, ActuatorMem=A_Mem)
